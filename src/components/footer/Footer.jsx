...
function Footer() {
  return (
    <>
      <section class="flex flex-col  lg:justify-end font-space text-[#da0404]">
          ...
          <div class="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-0">
            <div class="flex items-center justify-center pb-3 border-b border-gray-300 dark:border-gray-700 lg:justify-between">
              <div class="hidden mr-12 lg:block">
                <span class="text-[#da0404] dark:text-gray-400">
              ...
              <div class="flex justify-center ">
                ...
                <a
                  target="_blank"
                  href="https://www.instagram.com/cyberteam/"
                  class="mr-6 text-gray-600 dark:text-gray-400 hover:text-blue-400"
                >
                  <img
                    src={Instagram}
                ...
                <a
                  ...
                  target="_blank"
                  href="https://github.com/cyberteam"
                  aria-label="GitHub"
                ...
                <a
                  target="_blank"
                  href="https://www.linkedin.com/company/cyberteam/"
