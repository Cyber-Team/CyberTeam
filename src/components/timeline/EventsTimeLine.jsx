  ...
  return (
    <>
      <div class="w-full md:mx-5 md:px-10 font-space">
        <div class="flex flex-col md:grid grid-cols-9 mx-auto p-2 text-[#da0404] ">
          {/* <!-- left --> */}

          <div class="flex flex-row-reverse md:contents">
            <div class="bg-transparent  text-[#da0404]  col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
              ...
              >
                <p>
                  <b className="text-blue-gray-600">cyberteam:~/events$ </b>{" "}
                ...
                <p>
                  <b className="text-blue-gray-600">
                    [sudo] password for cyberteam:
                  </b>{" "}
                  <b className="text-light-green-300"></b>
                </p>
                <p>
                  <b className="text-blue-gray-600">
                    [root@cyberteam superuser]#
                  </b>{" "}
                  <b className="text-light-green-300">
          ...
          <div class="flex md:contents">
            ...
            <div class="bg-transparent  text-[#da0404]  col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
              <EventTerminal
                title="lug:~$cli-v.0.0.1x"
                children="coiacascasuin"
              >
