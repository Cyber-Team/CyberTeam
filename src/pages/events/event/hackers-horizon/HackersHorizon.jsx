  ...
  return (
    <>
      ...
      <div class="bg-transparent font-space">
        <div class="text-[#da0404] container  mx-auto p-8 overflow-hidden md:rounded-lg md:p-10 lg:p-12">
          <p class="font-space text-4xl font-bold text-[#da0404] max-w-5xl lg:text-7xl lg:pr-24 md:text-6xl">
            Hacker's Horizon
          </p>
          <div class="h-10"></div>
