    ...
    <>
      ...
      <div className="flex flex-row flex-wrap  ">
        ...
        <div className="sm:w-2/6  flex flex-col mt-5 justify-center items-center pl-5 pr-5">
          <TerminalWindow title="lug:~$cli-v.0.0.1x" children="coiacascasuin">
            ...
            {/* <br />   */}
            <p>
              <b className="text-blue-gray-600">[sudo] password for cyberteam:</b>{" "}
              <b className="text-light-green-300"></b>
            </p>
            <p>
              <b className="text-blue-gray-600">[root@cyberteam superuser]#</b>{" "}
            ...
            />
            <br />
            Type 'sudo cyberteam' to use our CLI|
            <pre>
              $~:{" "}
              <input
                ref={valueRef}
      ...
      <div class="flex flex-col w-full mt-0 lg:flex-row sm:mt-10 lg:mt-0">
        <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
          <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
            <svg
              class="absolute w-full h-full text-[#da0404] fill-current"
              viewBox="0 0 377 340"
            ...
            <h4 class="relative mt-6 mb-3 text-5xl font-bold font-space text-[#da0404]">
              <CountUp delay={1} end={10} />+
            </h4>
            <p class="relative text-3xl mt-5  text-center text-[#da0404] font-space">
              Events
            </p>
          </div>
        </div>
      ...
      {/* <div className="px-4 mx-auto max-w-7xl sm:px-6 sm:py-6 sm:my-3  lg:px-8 relative ">
        <div className="grid grid-cols-1 gap-2 mt-12 sm:grid-cols-3 lg:mt-20   ">
          <a
            href="#"
            className="transition-all  duration-1000  bg-transparent backdrop-blur-sm hover:bg-[#16161A]  hover:shadow-xl m-2 p-4 relative z-40 group   text-[#da0404] "
          >
            <div className=" absolute text-[#da0404]  bg-[#16161A]/50 top-0 left-0 w-24 h-1 z-30  transition-all duration-200   group-hover:bg-white group-hover:w-1/2  "></div>
            <div className="py-2 px-9 relative text-center font-thin ">
              <h2 className="text-5xl text-[#da0404]">
                <CountUp delay={1} end={1230} />+
              </h2>
              <h3 className="mt-8 text-3xl font-semibold text-[#da0404] font-space group-hover:text-[#da0404] opacity-100">
                Participants
              </h3>
            </div>
          </a>
          <a
            href="#"
            className="transition-all  duration-1000  bg-transparent hover:bg-[#16161A]  hover:shadow-xl m-2 p-4 relative z-40 group   text-[#da0404]"
          >
            <div className=" absolute text-[#da0404]  bg-[#16161A]/50 top-0 left-0 w-24 h-1 z-30  transition-all duration-200   group-hover:bg-white group-hover:w-1/2  "></div>
            <div className="py-2 px-9 relative text-center font-thin ">
              <h2 className="text-5xl text-[#da0404]">
      ...
      <div className="px-3 md:lg:xl:px-40    py-20 bg-opacity-10">
        <div className="grid grid-cols-1 md:lg:xl:grid-cols-3 group bg-transparent shadow-xl shadow-neutral-100  ">
          <div className="p-10 flex flex-col items-center text-center group  hover:bg-slate-50 cursor-pointer">
            <span className="p-5 rounded-full bg-tranparent text-[#da0404] shadow-lg shadow-gray-200">
              <img src={gfg} alt="" />
            </span>
            <p className="text-xl font-medium text-[#da0404] font-space mt-3">
              Geeks for Geeks
            </p>
            <p className="mt-2 text-sm text-[#da0404] font-space">
          ...
          <div className="p-10 flex flex-col items-center text-center group  hover:bg-slate-50 cursor-pointer">
            <span className="rounded-full  text-[#da0404] shadow-lg shadow-gray-200">
              <img
                src={cyberpeace}
