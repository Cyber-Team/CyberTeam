...
export default function Leaderboard() {
  ...
  return (
    <>
      ...
      {/* top cards */}
      <div className="flex flex-row flex-wrap justify-center items-center font-space text-[#da0404]">
          ...
          <div class="py-8">
            ...
            <div class="my-2 flex sm:flex-row flex-col opacity-70">
              <div class="flex flex-row mb-1 sm:mb-0">
                ...
                <div class="relative">
                  <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-[#da0404] ">
                    <svg
              ...
              <div class="block relative ">
                ...
                <input
                  ...
                  placeholder="Search"
                  class="appearance-none rounded-r rounded-l sm:rounded-l-none  block pl-8 pr-6 py-2 w-full bg-[#1A1920] text-sm placeholder-gray-400 text-[#da0404] focus:bg-[#1A1920] focus:placeholder-gray-600 focus:text-[#da0404] focus:outline-none"
                />
              </div>
            </div>
                          ...
                          <tr>
                            <td class="px-5 py-5 border-b border-gray-200 bg-[#16161A] text-sm">
                              <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                  <p class="text-[#da0404] whitespace-no-wrap text-md">
                                    {name}
                                  </p>
                                  <p class="text-[#da0404] font-thin text-sm whitespace-no-wrap">
                                    {reg_no}
                                  </p>
                                </div>
                              </div>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-[#16161A] ">
                              ...
                              <p class="text-[#da0404] whitespace-no-wrap text-sm">
                                {member_type}
                              </p>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-[#16161A] text-md">
                              <p class="text-[#da0404] ml-5">{contributions}</p>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-[#16161A] text-sm">
                              <span class="relative inline-block px-3 py-1 font-semibold text-[#da0404] leading-tight">
                                <span
                                  aria-hidden
