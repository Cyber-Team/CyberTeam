  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center font-space  my-5 py-5">
        <p class="max-w-5xl px-5 mt-2 text-md  leading-tight text-center text-[#da0404] sm:mt-10 sm:px-0 sm:text-2xl">
          Chapter - 1
        </p>
        <div className="h-4"></div>
        <p class="max-w-5xl px-5 mt-2 text-4xl  leading-tight text-center text-[#da0404] sm:mt-0 sm:px-0 sm:text-5xl">
          Linux: What? Why? How?
        </p>
      </div>
      ...
      <div class="p-8">
        <div class="bg-[#16161A] p-4 rounded-lg shadow-xl py-8 mt-12">
          <h4 class="text-4xl font-thin font-space text-[#da0404] tracking-widest uppercase text-center">
            Knowledge Center
          </h4>
          {/* <p class="text-center text-[#da0404] font-space text-sm mt-2"></p> */}
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 xl:gap-12 px-2 xl:px-12 mt-4">
            <div class="flex flex-row space-x-8 mt-8">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-12 w-12 text-[#da0404]"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <div>
                ...
                <p class="text-[#da0404] font-space my-2 font-thin">
            ...
            {/* <div class="flex flex-row space-x-8 mt-8">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-[#da0404]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div>
                    ...
                    <p class="text-[#da0404] font-space my-2 font-thin">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, dignissimos. Neque eos, dignissimos provident reiciendis debitis repudiandae commodi perferendis et itaque, similique fugiat cumque impedit iusto vitae dolorum. Nostrum, fugit!</p>
      ...
      <div class="px-4 py-20 bg-[#16161A] text-[#da0404] font-space">
