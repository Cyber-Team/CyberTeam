...
function Member() {
        ...
        <div className="space-y-4 text-center divide-y ">
          ...
          <div className="flex justify-center pt-2 space-x-4 align-center">
            ...
            <a href={instagram} target="_blank" className="p-1.5 rounded-md  ">
              <img src={Instagram} className="h-[19px] w-[19px] text-white" alt="" />
            </a>
            <a
              rel="noopener noreferrer"
              href={email}
  ...
  return (
    <>
      ...
      <div className="flex justify-center w-full">
        <div className="mx-1 px-1 w-[40rem] ">
          <EventTerminal title="lug:~$cli-v.0.0.1x" children="coiacascasuin">
            <p>
              <b className="text-blue-gray-600">cyberteam:~/members$ </b>{" "}
              <b className="text-light-green-300">
                sudo cyberteam run -it members.ion{" "}
              </b>
            </p>
            {/* <br />   */}
            <p>
      ...
      <div className="flex flex-row flex-wrap justify-center items-center text-[#da0404] font-space">
        {members2023}
      </div>
